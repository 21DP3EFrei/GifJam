...
<div class="container mx-3">
        ...
        <form id="myform" action="{{ route('genre.update', ['genre' => $genre->Z_ID]) }}" method="POST" class="mt-2 px-8 rounded-xl">
            ...
            <div class="my-5 flex flex-col">
                ...
                <textare title="{{ __('translation.titlegenredesc') }}" class="input input-md border rounded-sm bg-gray-200 dark:!bg-blue-900 dark:text-white dark:active:!bg-blue-900 dark:focus:!bg-blue-900 dark:focus:text-white autofill:!bg-black w-full" autocomplete="off" id="description" name="Apraksts">{{ $genre->Apraksts }}</textare>
            </div>
            @if (Zanrs::count() > 1)
            <div class="my-5 flex flex-col">
