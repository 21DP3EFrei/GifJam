...
<div class="container ml-8 flex flex-col w-auto pb-3">
  ...
  @if (!$check)
  <div class="flex flex-wrap space-x-2 sm:flex-row sm:flex-wrap py-3">
    <p>{{ __('translation.welcomemsg') }}</p>
  ...
  <p>{{ __('translation.welcomemsg2') }}</p>
...
switch($random) {
      ...
      case 14:
        ...
        break;
      case 15:
        echo '<p>' . __('translation.welcome14') . '</p>';
        break;
      case 16:
        echo '<p>' . __('translation.welcome15') . '</p>';
        break;  
      case 17:
      ...
      case 21:
       ...
       case 22:
        ...
        break;  
       case 23:
        echo '<p>' . __('translation.welcome22') . '</p>';
        break;  
      case 24:
