    ...
    @endif
        <form action="{{ route('verification.update', ['media' => $media->Me_ID]) }}" method="POST" class="mt-2 px-8 rounded-xl">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" class="input input-md border rounded-sm bg-gray-200 dark:!bg-blue-900 dark:text-white dark:active:!bg-blue-900 dark:focus:!bg-blue-900 dark:focus:text-white autofill:!bg-black w-full" required oninvalid="this.setCustomValidity('{{ __('translation.fillFileName') }}')"oninput="this.setCustomValidity('')" autocomplete="off" id="Nosaukums" name="Nosaukums" value="{{ $media->Nosaukums }}" required>
            </div>
            <div class="form-group mb-2">
            ...
            <td class="text-center">
                ...
                <div class="my-5 flex flex-col">
                    ...
                    <select class="select input-sm rounded-sm bg-gray-200 dark:bg-blue-900 dark:text-white  dark:active:bg-blue-900 dark:focus:bg-blue-900 dark:focus:text-white w-full" name="Kategorija_id" id="Kategorija_id" required oninvalid="this.setCustomValidity('{{ __('translation.fillFileCategory') }}')"oninput="this.setCustomValidity('')">
            ...
            @elseif ($media->Multivides_tips === 'Sound')
                <div class="my-5 flex flex-col">
                    <label for="SoundKategorija_id" class="form-label">{{ __('translation.sc') }}</label>
                    <select class="select input-sm rounded-sm bg-gray-200 dark:bg-blue-900 dark:text-white  dark:active:bg-blue-900 dark:focus:bg-blue-900 dark:focus:text-white w-full" name="SoundKategorija_id" id="SoundKategorija_id" required oninvalid="this.setCustomValidity('{{ __('translation.fillFileCategory') }}')"oninput="this.setCustomValidity('')">
            ...
            @elseif ($media->Multivides_tips === 'Music')
                <div class="my-5 flex flex-col">
                    ...
                    <select class="select input-sm rounded-sm bg-gray-200 dark:bg-blue-900 dark:text-white  dark:active:bg-blue-900 dark:focus:bg-blue-900 dark:focus:text-white w-full" name="Zanrs_id" id="Zanrs_id" required oninvalid="this.setCustomValidity('{{ __('translation.fillFileGenre') }}')"oninput="this.setCustomValidity('')">
