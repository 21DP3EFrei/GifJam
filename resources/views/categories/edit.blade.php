...
<div class="container mx-3">
    ...
    @endif
        ...
        @endif
        <form id="myform" action="{{ route('categories.update', ['categories' => $categories->K_ID]) }}" method="POST" class="mt-2 px-8 rounded-xl">
            @csrf
            @method('PUT')
            ...
            <div class="form-group mb-2">
                ...
                <textarea title="{{ __('translation.titlecategorydesc') }}" class="input input-md border rounded-sm bg-gray-200 dark:!bg-blue-900 dark:text-white dark:active:!bg-blue-900 dark:focus:!bg-blue-900 dark:focus:text-white autofill:!bg-black w-full" autocomplete="off" id="description" name="Apraksts">{{ $categories->Apraksts }}</textarea>
            </div>
            @if (Kategorija::count() > 1)
            <div class="form-group mb-2">
