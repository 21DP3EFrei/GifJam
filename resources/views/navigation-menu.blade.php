<nav x-data="{ open: false }" class="dark:border border-gray-300 dark:border-gray-600 outline-black dark:bg-gray-800" aria-label="Main Navigation">
    <div class="max-w-7xl mx-auto px-3 md:px-6 lg:px-8 flex justify-between items-center py-4">
        <!-- Logo -->
        ...
        <div class="hidden md:flex space-x-3"> 
                ...
                <div x-show="open" @click.away="open = false" class="absolute mt-12 w-60 px-2 pr-2 bg-gray-100 dark:bg-gray-800 border rounded-xl z-50 shadow-lg">
                    <div class="py-1 flex flex-col">
                        <x-nav-link href="{{ route('categories.index') }}" :active="request()->routeIs('categories.index')" class="py-2">
                            <img class="h-7 w-7 mr-1" src="{{ asset('images/image.svg') }}" alt="">
            ...
            <div class="hidden md:flex md:ms-1 items-center">
                <div class="ms-3 relative">
                    <a href="{{ route('random') }}"  class="inline-flex bg-white items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md hover:text-gray-700 text-black focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                            ?
                    </a>
                </div>
            </div>
        ...
        <!-- Profile Section -->
        <div class="hidden md:flex sm:items-center sm:ms-1 justify-between">
            <div class="hidden sm:flex sm:ms-1">
                <div class="ms-3 relative">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                    <span class="inline-flex rounded-md">
                                        <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-gray-300 dark:bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link href="{{ route('upload') }}">
                                    <img class="h-7 w-7 mr-1" src="{{ asset('images/picture.svg') }}" alt="Picture upload">
                                    {{ __('Image upload') }}
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('uploadSound') }}">
                                    <img class="h-7 w-7 mr-1" src="{{ asset('images/sound.svg') }}" alt="Sound upload">
                                    {{ __('Sound upload') }}
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('uploadMusic') }}">
                                    <img class="h-7 w-7 mr-1" src="{{ asset('images/music.svg') }}" alt="Music upload">
                                    {{ __('Music upload') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
