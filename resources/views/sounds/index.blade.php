    ...
    <form method="GET" id="filterForm" class="mx-2">
        ...
        <div class="flex gap-5 items-start">
            <div class="col-md-3 flex flex-col w-80">
                ...
                <select name="sound_category_id" class="input input-md rounded-sm bg-gray-200 dark:bg-blue-900 dark:text-white  dark:active:bg-blue-900 dark:focus:bg-blue-900 dark:focus:text-white" id="category">
            ...
            <div class="col-md-3 flex flex-col mt-6">
                <a href="{{ route('sounds.index') }}" class="p-2 btn-circle btn btn-error text-white border border-black inline-block">X</a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 mt-8">
            ...
            <input  type="text" class="grow input input-md rounded-sm bg-gray-200 dark:bg-blue-900 dark:text-white dark:active:bg-blue-900 dark:focus:bg-blue-900 dark:focus:text-white" id="searchInput" name="search" placeholder="Search sounds" autocomplete="off"/>
        ...
        <div class="table-responsive overflow-x-auto mx-3">
            ...
            <tbody>
                ...
                <tr class="align-middle items-center text-center hover:bg-gray-200 dark:hover:bg-gray-700 border border-gray-300">
                        {{-- <a href="{{ route('sounds.show', $sounds->Sk_ID) }}" class="btn btn-sm btn-primary"> --}}
                        <td>{{ $sounds->Nosaukums }}</td>

                        <td>{{ $sounds->Apraksts }}</td>
