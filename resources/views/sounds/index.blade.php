...
<div class="container mx-auto py-1 px-2">
    ...
    <form method="GET" id="filterForm">
        ...
        <div class="flex items-center gap-2 mt-8 mb-2">
            ...
            <input  type="text" class="grow input input-md rounded-sm bg-gray-200 dark:bg-blue-900 dark:text-white dark:active:bg-blue-900 dark:focus:bg-blue-900 dark:focus:text-white" id="searchInput" name="search" placeholder="{{ __('translation.searchSound') }}" autocomplete="off"/>
