...
return [
    ...
    */
    ...
    'currentPassword' => "Введённый пароль не совпадает с вашим текущим паролем.",
    '2authPError' => 'Введённый код двухфакторной аутентификации недействителен.',
    '2authRError' => 'Введённый код восстановления недействителен.',
];
